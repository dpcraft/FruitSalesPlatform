...
<div class="commoditiesMask">
    <div class="c2">
        <div style="background-color: #173e65;height: 20px;color: #fff; font-size: 12px; padding-left: 7px;">
            水果列表<span style="float:right;padding-right:10px;" onclick="cancelEdit()">x</span>
        </div>
        <input id="commoditiesName" width="20%"/>
        <button class="btn" onclick="SearchCommodities()">查询</button>
        <div id="commoditiesList" style="border: 2px solid #ccc; height: 230px;overflow-y:scroll;margin:10px;"></div>
...
<div class="retailerMask">
    <div class="c">
        <div style="background-color: #173e65; height: 20px;color: #ffffff;font-size: 12px;padding-left: 7px;">
            零售商信息 <span style="float:right;padding-right: 10px;" onclick="cancelEdit()">x</span>
        </div>
        <input id="retailerName" width="20%"/>
        <button class="btn" onclick="SearchRetailer()">查询</button>
        <div id="retailerList" style="border:5px solid #CCCCCC; height: 220px;overflow-y: scroll;margin: 10px;">
